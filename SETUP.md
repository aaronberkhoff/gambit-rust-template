...
2. Click the **Sync template files** workflow run.
3. Open the **Push to downstream repos** job.
4. Expand the **Sync files to each repo** step — each downstream repo appears
